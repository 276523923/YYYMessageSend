...
extern __attribute((overloadable)) id Y_SEL_Exec(id target, SEL sel, ...);
extern __attribute((overloadable)) id Y_SEL_Exec(id target, SEL sel, va_list list);
extern __attribute((overloadable)) id Y_SEL_Exec(id target, SEL sel, va_list list, NSError **error);
